 ...
 ?>
    <div class="container">
      <div class="row">
        ...
        <input name="id" type="hidden" value="<?php echo $conferencia['iconferencia']?>">
          <div class="form-group col-md-6">
            <label for="nom">Nombre:</label>
            <input name="nom" type= "Text" class="form-control" placeholder="Nombre del Evento" value="<?php echo $conferencia['nombre']?>">
          ...
          <div class="form-group col-md-6">
            ...
            <input name="fecha" type="date" class="form-control" placeholder="Fecha" value="<?php echo $conferencia['fecha']?>">
          </div>

          <div class="form-group col-md-6">
            <label for="lugar">Lugar</label>
            <input type="text" name="lugar" class="form-control" placeholder="Sede" value="<?php echo $conferencia['lugar']?>">
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="time" name="hora" class="form-control" placeholder="hh:mm" value="<?php echo $conferencia['hora']?>">
          </div>
